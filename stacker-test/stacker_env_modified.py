...
class StackerEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if done:
            ...
            terminal_info.obs, terminal_info.reward, terminal_info.interrupted))
    ...
    def reset(self):
        ...
        if obs is None:
            if self.dict_obs:
                ...
                obs = np.array([0, self.np_random.uniform(-1, 1), self.np_random.uniform(-1, 1)]) # setting relations at first, center of gravity next
                print("obs", obs)
